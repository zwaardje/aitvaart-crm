...
export default function PermissionsPage() {
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center py-8">
          <RiShieldLine className="h-12 w-12 mx-auto mb-4 text-gray-300" />
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center py-8">
          ...
          <p className="text-gray-500 mb-4">
            You don&apos;t have permission to manage permissions. Only
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <PermissionManager organizationId={userOrganization.organization_id} />
    </div>
  );
}
